...
<html lang="en">
  <head>
    ...
    <title>Teacher Login - JU Project Distribution System</title>
    <!-- Google font-->
            ...
            <div>
              ...
              <div class="login-main"> 
                <form class="theme-form" method="POST" action="{{ route('authenticate') }}">
                  @csrf
                  <h4 class="text-center">Sign in as Teacher</h4>
                  <p class="text-center">Enter your email & password to login</p>
                  <div class="form-group">
                    <label class="col-form-label">Email Address</label>
                    <input class="form-control" type="email" name="tchr_email" value="{{old('tchr_email')}}" placeholder="Test@gmail.com" required>
                    @error('tchr_email')
